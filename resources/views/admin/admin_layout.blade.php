...
@if( Auth::check() && Auth()->user()->product == 1)
     <a href="{{ route('all.product') }}" class="sl-menu-link {{'admin/product/add' == request()->path()?'active':''}} {{'admin/product/all' == request()->path()?'active':''}}">
...
@endif
      ...
      @endif
        ...
        @if(Auth::check() && Auth::user()->user_role == 1)
         ...
         <a href="{{ route('alluser.role') }}" class="sl-menu-link {{'admin/create/user_roll' == request()->path()?'active':''}} {{'admin/all/user_roll' == request()->path()?'active':''}}">
          <div class="sl-menu-item">
