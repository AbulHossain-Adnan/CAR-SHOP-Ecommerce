  ...
  <div class="col-sm-3 m-auto">
    <div class="card">
      <div class="card-body m-auto">
       @if(Auth::user()->image)
          <img src="{{asset('user_images/'.Auth::user()->image)}}" style="width:200px;">
          
      @else
       <img src="{{asset('user_images/avatar/default.jpg')}}" style="width:200px;">
      @endif
...
<form method="post" action="{{url('/user/profile_image/update/'.Auth()->id())}}" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="file" class="form-control" id="exampleInputEmail1" name="image" required="" aria-describedby="emailHelp" placeholder="Enter email">
